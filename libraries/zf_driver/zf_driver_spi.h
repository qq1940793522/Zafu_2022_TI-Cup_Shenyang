...
typedef enum                                                                    // 枚举串口引脚 此枚举定义不允许用户修改
{
    ...
    SPI3_MOSI_C7        = 0x2547,                                               // 0x 2[SPI3] 5[AF5] 47[C7]
    SPI3_MOSI_C11       = 0x264B,                                               // 0x 2[SPI3] 6[AF6] 4B[C11]
    SPI3_MOSI_D5        = 0x2565,                                               // 0x 2[SPI3] 5[AF5] 65[D5]
    SPI3_MOSI_D13       = 0x266D,                                               // 0x 2[SPI3] 6[AF6] 6D[D13]
}spi_miso_pin_enum;
