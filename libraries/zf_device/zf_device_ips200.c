...
{
    *(volatile uint16 *)IPS200_DATA_ADD = ((uint16)dat << 8);
}
...
void ips200_init (ips200_type_enum type_select)
{
    ...
    else
    {
        ...
        afio_init(IPS200_CS_PIN_PARALLEL8, GPO, GPIO_AF12, GPO_AF_PUSH_PULL);   // FSMC_NE1 IPS200_CS
        afio_init(IPS200_RS_PIN_PARALLEL8, GPO, GPIO_AF12, GPO_AF_PUSH_PULL);   // FSMC_A18 IPS200_RS
